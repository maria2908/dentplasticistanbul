...
<template>
  <div>
    ...
    <div class="mt-4 flex flex-col md:flex-row mx-4 md:mx-0 ">
      <p class="shadow md:w-1/2 bg-customGray bg-opacity-70 p-6 sm:p-8 md:p-14 rounded-2xl mb-4 md:mb-0 md:mr-4 text-sm md:text-lg">
        {{ $t('breast-enlargement.main.text-1')}}
      </p>
      <p class="shadow md:w-1/2  bg-customGray bg-opacity-70 p-6 sm:p-8 md:p-14 rounded-2xl md:ml-4 text-sm md:text-lg">
