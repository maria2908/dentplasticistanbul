    ...
    <div class="timeline relative mx-auto w-full md:w-4/5 lg:w-3/4 flex flex-col">
      <div class="timeline-item flex justify-between items-center mb-12 md:h-48">
        <div class="timeline-content  md:pr-8 w-full md:w-1/2">
          <p class="pr-6 text-left">{{ $t('breast-enlargement.visit.step-1')}}</p>
        </div>
      ...
      <div class="timeline-item flex justify-between items-center mb-12 md:h-48">
        ...
        <div class="timeline-content w-full md:w-1/2 md:pl-8">
          <p class="pl-6 text-left">{{ $t('breast-enlargement.visit.step-2')}}
          </p>
        </div>
      </div>
      ...
      <div class="timeline-item flex justify-between items-center mb-12 md:h-48">
        <div class="timeline-content md:pr-8 w-full md:w-1/2">
          <p class="pr-6 text-left">{{ $t('breast-enlargement.visit.step-3')}}</p>
        </div>
        <div class="timeline-dot"></div>
      ...
      <div class="timeline-item flex justify-between items-center mb-12 md:h-48">
        ...
        <div class="timeline-dot"></div>
        <div class="timeline-content w-full md:w-1/2 md:pl-8">
          <p class="pl-6 text-left">{{ $t('breast-enlargement.visit.step-4')}}</p>
        </div>
      </div>
